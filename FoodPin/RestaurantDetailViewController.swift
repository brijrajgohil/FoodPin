...
class RestaurantDetailViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 4:
            cell.fieldLabel.text = NSLocalizedString("Been Here", comment: "Have you been here")
            if let isVisited = restaurant.isVisited?.boolValue {
                cell.valueLabel.text = isVisited ? NSLocalizedString("Yes, I've been here before", comment: "Yes, I've been here") : NSLocalizedString("No", comment: "No, I haven't been here")
            }
        default:
